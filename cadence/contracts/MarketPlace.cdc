...
pub contract MarketPlace {
    ...
    pub resource interface SalePublic {
        pub fun purchase(tokenID: UInt64, recipient: Capability<&AnyResource{XNFT.NFTReceiver}>, buyTokens: @TAPToken.Vault)
    ...
    pub resource SaleCollection: SalePublic {
        ...
        access(self) var ownerCollection: Capability<&XNFT.Collection>
        ...
        init (ownerCollection: Capability<&XNFT.Collection>, 
    ...
    pub fun createSaleCollection(ownerCollection: Capability<&XNFT.Collection>, 
